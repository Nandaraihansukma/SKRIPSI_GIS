            ...
            <div className="p-6.5">
              ...
              {/* <div className="mb-4.5">
                ...
                <TextInput
                  ...
                  name="mulai_bekerja"
                  type="date"
                  placeholder="Masukan tanggal mulai bekerja"
                  onChange={(e) => {
                    if (
                      e.target.value != "" &&
              ...
              {/* <div>
                <div className="mb-2 block">
                  <Label
                    className="text-md"
                    htmlFor="waktu_kecelakaan"
                    value="Tanggal mulai Bekerja"
                  />
                </div>
                <TextInput
                  id="waktu_kecelakaan"
                  name="waktu_kecelakaan"
                  type="datetime-local"
                  placeholder="Masukan waktu kecelakaan"
                  onChange={(e) => {
                    if (
                      e.target.value != "" &&
                      new Date(e.target.value) > new Date()
              ...
              <button
                className="flex justify-center rounded bg-[#263238] p-3 font-medium text-white"
                type="submit"
              >
                Tambah
              </button>
